...
const CalendarGrid: React.FC = () => {
    ...
    const getDays = (): ReactElement[] => {
        return Array.from({ length: 7 }, (_v, index) => {
            ...
            return <span className={`flex flex-col items-center justify-center p-2 rounded-md ${isToday ? 'bg-blue-100 font-semibold' : ''}`} key={dayName}>
                <span>{dayName}</span>
    ...
    return (
        <div className='flex-1 overflow-hidden p-6 rounded-md min-w-0'>
